...
public class Attendance_Cls {
	...
	public Attendance_Cls(int att_id, int att_emp_id, int attend_totals_days, int att_month, Date date_form,
	...
	@OneToMany(mappedBy = "Attendance_Cls")
    private Set<Employee> attendance = new HashSet<>();
}
